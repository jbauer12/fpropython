...
from logic.classes import Piece, PieceWithPositions, GameBoard
...
def get_possible_move_vectors(piece: Piece, is_piece_there: bool) -> Tuple[Tuple[int, int], ...]:
    if is_piece_there:
...
def get_possible_moves(game_board: GameBoard, piece: Piece,
                       vectors_which_piece_can_move: Tuple[Tuple[int, int], ...],
...
def get_all_possible_moves_for_piece(game_board: GameBoard, piece: Piece, possible_move_function: Callable) \
    ...
    vectors_which_piece_can_move = get_possible_move_vectors(piece=piece, is_piece_there=is_piece_there_on_row_column(game_board=game_board, piece=piece))
